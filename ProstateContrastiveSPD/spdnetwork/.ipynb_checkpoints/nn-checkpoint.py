...
class CovPool(nn.Module):
    ...
    def forward(self,f):
#         print(f'FORWARD COVPOOL')
        out = functional.cov_pool(f,self._reg_mode)
#         print(f'out CovPool insied: {out.shape}')
        return out
